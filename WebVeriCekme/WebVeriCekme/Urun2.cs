...
namespace ConsoleAppVeriCekme
{
    class Urun2
    {
        internal static void Urun_2()
        {
          ...
          //  YeniGoruntulenmeSayisi = GoruntulenmeSayisiniOku().Replace("\n", "");
            ...
            try
            {
                ...
                //Ürünlerden 2.si
                string sqlUrunBilgileri = "Select UrunAdi,GoruntulenmeSayisi,Fiyat from UrunBilgileri where UrunAdi='Davidoff Cool Water Edt Erkek Parfüm 125ml'";
                ...
                if (DataSetKontrol(dsUrunBilgileri))
                {
                    ...
                    if ((YeniUrunFiyatiD - EskiUrunFiyatiD) < Convert.ToDouble(farkdeger) || (YeniUrunFiyatiD - EskiUrunFiyatiD) > Convert.ToDouble(farkdeger))//Aradaki far parametrede belirlenen degerden farklıysa kontrolü yapılır
                    {
                        ...
                        command.CommandText = "update UrunBilgileri set  GoruntulenmeSayisi= @GoruntulenmeSayisi ,Fiyat=@Fiyat where UrunAdi='Davidoff Cool Water Edt Erkek Parfüm 125ml'";
                ...
                else
                {
                    ...
                    command.Parameters.AddWithValue("@UrunAdi", "Davidoff Cool Water Edt Erkek Parfüm 125ml");
            ...
            {
                Console.WriteLine("Hata1.2: " + ex.Message);
            }
        }
        public static string FiyatiniOku()
        {
            try
            {
                var url = new Uri("https://www.rossmann.com.tr/davidoff-cool-water-edt-erkek-parfum-125ml-p-st11060143");
            ...
            {
                Console.WriteLine("Hata2.2: " + ex.Message);
            }
